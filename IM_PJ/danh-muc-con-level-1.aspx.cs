...
namespace IM_PJ
{
    public partial class danh_muc_con_level_1 : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            if (ParentID > 0)
            {
                ...
                if (parent != null)
                {
                    ...
                    {
                        lblCategoryName.Text = parent.CategoryName;
                        ltrAddnew.Text += "<a href=\"/quan-ly-danh-muc-san-pham\" class=\"btn primary-btn h45-btn\">Trở về</a>  ";
                        ltrAddnew.Text += "<a href=\"/them-danh-muc-con-level-1?pid=" + ParentID + "\" class=\"h45-btn btn\" style=\"background-color: #ff3f4c\">Thêm mới danh mục con</a>";
        ...
        public void pagingall(List<tbl_Category> acs)
        {
            ...
            if (acs.Count > 0)
            {
                ...
                for (int i = FromRow; i < ToRow + 1; i++)
                {
                    ...
                    html.Append("   <td>");
                    html.Append("       <a href=\"/thong-tin-danh-muc-con-level-1.aspx?id=" + item.ID + "\" class=\"btn primary-btn h45-btn\">Chi tiết</a>");
