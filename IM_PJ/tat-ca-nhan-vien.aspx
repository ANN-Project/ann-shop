<%@ Page Title="Tất cả nhân viên" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="tat-ca-nhan-vien.aspx.cs" Inherits="IM_PJ.tat_ca_nhan_vien" %>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="right above-list-btn">
                        ...
                        <a href="/them-moi-nhan-vien" class="h45-btn btn" style="background-color: #ff3f4c">Thêm mới</a>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="filter-above-wrap clear right">
                        <div class="filter-control right">
                            <div class="col-md-4">
                                <asp:TextBox ID="txtAgentName" runat="server" CssClass="form-control" placeholder="Nhập username hoặc tên nhân viên để tìm"
                                    Width=""></asp:TextBox>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-3">
                                <asp:DropDownList ID="ddlRole" runat="server" CssClass="form-control">
                                    <asp:ListItem Value="0" Text="-- Tất cả quyền --"></asp:ListItem>
