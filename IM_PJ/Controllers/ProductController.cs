...
namespace IM_PJ.Controllers
{
    public class ProductController
    {
        ...
        public static List<ProductSQL> GetAllSql(int categoryID, string textsearch)
        {
            ...
            sql += "     ORDER BY ";
            sql += "             PRD.ProductStyle ";
            sql += "     ,       PRD.ID ";
            sql += "     ; ";
            sql += "  ";
            sql += "     CREATE INDEX [ID_PROCDUCT] ON #Product([ProductStyle], [ID]) ";
            sql += "  ";
            sql += "     SELECT ";
            sql += "             STM.ProductID ";
            sql += "     ,       STM.Quantity ";
            ...
            sql += "         ON  PRD.ProductStyle = 1 ";
            sql += "         AND PRD.ID = STM.ParentID ";
            sql += "     ORDER BY ";
            sql += "             STM.ProductID ";
            sql += "     ,       STM.CreatedDate ";
            sql += "     ; ";
            ...
            sql += "  ";
            sql += "     SELECT ";
            sql += "             STM.ProductVariableID ";
            sql += "     ,       STM.Quantity ";
            sql += "     ,       STM.QuantityCurrent ";
            sql += "     ,       STM.Type ";
            sql += "     ,       STM.CreatedDate ";
            sql += "     ,       STM.ParentID ";
            sql += "     INTO #StockProductVariable ";
            sql += "     FROM ";
            sql += "             #Product AS PRD ";
            sql += "     INNER JOIN tbl_StockManager AS STM ";
            sql += "         ON  PRD.ProductStyle = 2 ";
            sql += "         AND PRD.ID = STM.ParentID ";
            sql += "     ORDER BY ";
            sql += "             STM.ProductVariableID ";
            sql += "     ,       STM.CreatedDate ";
            sql += "     ; ";
            sql += "  ";
            sql += "     CREATE INDEX [ID_PROCDUCT] ON #StockProductVariable( ";
            sql += "             [ProductVariableID] ASC ";
            sql += "     ,       [CreatedDate] DESC ";
            sql += "     ) ";
            sql += "  ";
            sql += "     SELECT ";
            sql += "             PRQ.ProductStyle ";
            sql += "     ,       PRQ.ParentID ";
            sql += "     ,       SUM(ISNULL(PRQ.QuantityLeft, 0)) AS QuantityLeft ";
            sql += "     INTO #ProductQuantity ";
            sql += "     FROM ( ";
            sql += "         SELECT ";
            sql += "                 1 AS ProductStyle ";
            sql += "         ,       STP.ParentID ";
            sql += "         ,       ( ";
            sql += "                     CASE STP.Type ";
            sql += "                         WHEN 1 ";
            ...
            sql += "                 ) AS QuantityLeft ";
            sql += "         FROM  ";
            sql += "                 #StockProductVariable AS STP ";
            sql += "         INNER JOIN ( ";
            sql += "                 SELECT ";
            sql += "                         ProductVariableID ";
            sql += "                 ,       MAX(CreatedDate) AS CreatedDate ";
            sql += "                 FROM ";
            sql += "                         #StockProductVariable ";
            sql += "                 GROUP BY ";
            sql += "                         ProductVariableID ";
            sql += "             ) AS SPM ";
            sql += "             ON  STP.ProductVariableID = SPM.ProductVariableID ";
            sql += "             AND STP.CreatedDate = SPM.CreatedDate ";
            sql += "     ) AS PRQ ";
            sql += "     GROUP BY ";
            sql += "             PRQ.ProductStyle ";
            ...
            sql += "     ; ";
            sql += "  ";
            sql += "     CREATE INDEX [ID_PROCDUCT] ON #ProductQuantity([ProductStyle], [ParentID]) ";
            sql += "  ";
            sql += "     SELECT ";
            ...
            sql += "         ON  p.ProductStyle = PRQ.ProductStyle ";
            sql += "         AND p.ID = PRQ.ParentID ";
            sql += "     LEFT JOIN ( ";
            sql += "             SELECT ";
            sql += "                     ID ";
            sql += "             ,       CategoryName ";
