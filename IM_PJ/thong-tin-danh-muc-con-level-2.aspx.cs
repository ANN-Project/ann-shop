...
namespace IM_PJ
{
    public partial class thong_tin_danh_muc_con_level_2 : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            if (id > 0)
            {
                ...
                if (a != null)
                {
                    ...
                    ltrBack.Text = "<a href=\"/danh-muc-con-level-2?pid=" + a.ParentID + "\" class=\"btn primary-btn fw-btn not-fullwidth\">Quay về danh sách</a>";
                    if (a.IsHidden != null)
            ...
            if (Session["userLoginSystem"] != null)
            {
                ...
                if (acc != null)
                {
                    if (acc.RoleID == 0)
                    {
                        ...
                        if (ca != null)
                        {
                            string kq = CategoryController.Update(ID, txtCategoryName.Text, txtCategoryDescription.Text, 2, Convert.ToInt32(ca.ParentID), chkIsHidden.Checked,
